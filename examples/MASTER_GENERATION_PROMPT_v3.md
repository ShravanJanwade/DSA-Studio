...
1. [Problem 1] — [Difficulty] — [LeetCode link] — [YouTube link]
2. [Problem 2] — [Difficulty] — [LeetCode link] — [YouTube link]
... (list all)
...
**YouTube:** [full URL — NeetCode/Striver/takeUForward/any best explanation video]
```
...
1. Implement Trie — Hard — https://leetcode.com/problems/implement-trie-prefix-tree/ — https://youtube.com/watch?v=oobqoCJlHA0
2. Longest Word With All Prefixes — Medium — [GFG link] — https://youtube.com/watch?v=AWnBa91lThI
3. Count Distinct Substrings — Hard — [GFG link] — https://youtube.com/watch?v=RV0QeTyHZxo
```
